	...
	eachBubbleFinishedCallBack: function(self) {
		...
		if (self.presentStep < self.bubbleInfos.length - 1) {
			...
			if (self.bubbleInfos[self.presentStep].trigger == "N") {
				...
				// CLICK이면.. 쿠키를 굽자~
				self.presentStep++;
				$.cookie('__webbles__lib__continuedStep__', String(self.presentStep), {'path': '/'});
			}
...
generalUtil.prototype = {
	...
	dimScreenExceptTarget: function(targetElement, evtType, zoomRect) {
		...
		var dimElements = {
			top: "<div id=\"__goDumber__shadow__top\" class=\"___tbb___ __goDumber__shadow__\" style=\"background-image:url('static/images/shadow1x1.png'); position:absolute; top:0; z-index:2147481000;\"></div>",
			bottom: "<div id=\"__goDumber__shadow__bottom\" class=\"___tbb___ __goDumber__shadow__\" style=\"background-image:url('static/images/shadow1x1.png'); position:absolute; z-index:2147481000;\"></div>",
			left: "<div id=\"__goDumber__shadow__left\" class=\"___tbb___ __goDumber__shadow__\" style=\"background-image:url('static/images/shadow1x1.png'); position:absolute; top:0; left:0; z-index:2147481000;\"></div>",
			right: "<div id=\"__goDumber__shadow__right\" class=\"___tbb___ __goDumber__shadow__\" style=\"background-image:url('static/images/shadow1x1.png'); position:absolute; top:0; z-index:2147481000;\"></div>"
		};
	...
	makeNewBubble: function(targetElement, bubbleData, onActionCallback, onCancleCallback, bubbleMakingMode) {
		...
		switch (bubbleMakingMode) {
			...
			case this.CONSTS.bubbleMakingMode.MM['modify']:
				...
				$.ajax({
					url: 'static/templates/speechBubble.html',
